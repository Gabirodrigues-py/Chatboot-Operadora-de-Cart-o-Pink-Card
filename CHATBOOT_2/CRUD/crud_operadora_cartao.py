...
# Este bloco garante que o banco de dados seja salvo na pasta correta (raiz do projeto)
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
# Usamos ".." para subir uma pasta e salvar o banco na raiz 'CHATBOOT'
...
def conectar():
    ...
    cursor = conn.cursor()
    # Criamos a tabela caso ela não exista para evitar erros de 'no such table'
    cursor.execute("""
